  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Extract headings for table of contents before setting blog state
        if (blogData?.content) {
        ...
        // Fetch recent posts (last 3 posts)
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm">
              ...
              <div className="space-y-4">
                {recentPosts.length > 0 ? (
                  recentPosts.map(post => (
                    ...
                    >
                      <div className="flex gap-4 items-start">
                        ...
                        <div>
                          <h3 className="text-sm font-medium text-gray-800 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors line-clamp-2">
                            {post.title}
                          </h3>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">No recent posts found</p>
                )}
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm">
              ...
              <div className="space-y-4 text-sm">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-gray-800 dark:text-gray-200">{estimateReadTime(blog.content)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 dark:text-gray-400">Published</span>
                  <span className="font-medium text-gray-800 dark:text-gray-200">{formatDate(blog.publishedAt || blog.createdAt)}</span>
                </div>
                {blog.updatedAt && (
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 dark:text-gray-400">Last Updated</span>
                    <span className="font-medium text-gray-800 dark:text-gray-200">{formatDate(blog.updatedAt)}</span>
                  </div>
                )}
              </div>
            </div>
