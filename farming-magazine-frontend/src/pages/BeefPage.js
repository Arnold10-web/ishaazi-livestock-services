      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-heading mb-6">
            Premium Beef Production: From Pasture to Profit
          </h1>
          <p className="text-body text-lg md:text-xl max-w-3xl mx-auto">
            Elevate your cattle operation with expert-driven strategies, sustainable grazing methods, and advanced herd management for superior beef quality and profitability.
          </p>
        </div>
        ...
        {/* In-Content Ad - placed after search results */}
        <div className="py-8">
          <DynamicAdComponent 
            adSlot="1122334455"
            adFormat="rectangle"
