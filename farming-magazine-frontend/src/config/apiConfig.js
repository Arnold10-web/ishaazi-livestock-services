...
const API_ENDPOINTS = {
  ...
  // Dashboard Statistics Cleanup Endpoints
  DASHBOARD_CLEAN_STATS: `${BASE_URL}/api/admin/dashboard/clean`,
  DASHBOARD_VALIDATE_VIEWS: `${BASE_URL}/api/admin/dashboard/validate-views`,
  DASHBOARD_RESET_DEV_VIEWS: `${BASE_URL}/api/admin/dashboard/reset-dev-views`,
...
DELETE_BEEF: (id) => `${BASE_URL}/api/content/beefs/${id}`,
  ...
  EMAIL_HEALTH_STATS: `${BASE_URL}/api/email/health`,
