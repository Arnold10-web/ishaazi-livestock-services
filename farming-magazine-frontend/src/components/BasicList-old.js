...
import { AlertCircle, Download, MessageSquare, Play, ChevronDown, ChevronUp, Edit2, Trash2 } from 'lucide-react';
  ...
  if (!basics || basics.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-1 text-sm text-gray-500">Check back later for new farming content.</p>
      </div>
    );
  }
            ...
            {item.imageUrl && (
              <div className="mb-4">
                <div className="relative bg-gray-100 rounded-lg overflow-hidden">
                  ...
                  />
                  {/* Simple play button for audio/video */}
              ...
              <div className="mb-4">
                <div 
                  className={`text-gray-700 ${
                    expandedDescriptions[item._id] ? '' : 'line-clamp-3'
                  }`}
                ...
                {stripHtmlTags(item.description).length > 150 && (
                  <button
                    ...
                    className="mt-2 text-green-600 hover:text-green-700 text-sm font-medium flex items-center"
                  >
            ...
            <div className="mt-4">
              <div className="flex space-x-3">
                <textarea
                  ...
                  className="flex-1 min-h-[80px] px-3 py-2 border border-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
                <button
