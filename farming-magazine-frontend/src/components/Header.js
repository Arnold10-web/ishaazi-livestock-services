...
import { Menu, X, Facebook, Instagram, MessageCircle, Search } from 'lucide-react';
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <Link to="/" className="flex-shrink-0 z-10">
              <img
                ...
                className="h-10 sm:h-12 w-auto max-w-[150px] sm:max-w-[200px] transition-all duration-300 rounded shadow-sm"
              />
            </Link>
            ...
            <div className="hidden lg:flex flex-1 items-center justify-between mx-4">
              ...
              <div className="flex-1 max-w-sm xl:max-w-md mx-4">
